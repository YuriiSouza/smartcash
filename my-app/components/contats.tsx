...
export default function ContactPage() {
  ...
  const [state, handleSubmit] = useForm("xeozqnnj");
  ...
  return (
    <div className="max-w-4xl mx-auto p-5 md:p-10 font-sans leading-relaxed text-gray-700 bg-white shadow-lg rounded-lg my-10">
      ...
      <p className="mb-8 text-lg text-center text-gray-600">
        Tem alguma dúvida, sugestão ou precisa de suporte? Preencha o formulário abaixo ou utilize nossos outros canais de contato. Estamos aqui para ajudar!
      </p>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10">
        {/* Seção do Formulário de Contato */}
        <div>
          <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-5">Envie-nos uma Mensagem</h2>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full bg-blue-600 text-white py-3 px-6 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 text-lg font-semibold transition duration-300"
        ...
        <div>
          <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-5">Outros Meios de Contato</h2>
          <div className="space-y-6 text-lg">
            <div className="flex items-center gap-1">
              ...
              <span>Email: <a href="mailto:yuripeixoto1112@gmail.com" className="text-blue-600 hover:underline">contato@smartcashinvestiment.com.br</a></span>
            </div>
            <div className="flex items-center">
                <div className="flex items-center space-between gap-1">
                ...
                <span>WhatsApp: <a href="https://wa.me/5562992722946" target="_blank" rel="noopener noreferrer" className="text-green-600 hover:underline">(DDD) Seu Número</a></span>
                </div>
              <p className="text-sm text-gray-500 ml-9 mt-1">(Apenas mensagens, por favor)</p>
            </div>
            <div className="flex items-center">
              <svg className="w-10 h-10 text-gray-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
              </svg>
              <span>Horário de Atendimento: <span className="font-semibold">Segunda a Sexta, das 9h às 18h (Horário de Brasília)</span></span>
            </div>
            <div className="flex items-center gap-1">
              ...
              <span>Redes Sociais: <a href="https://instagram.com/smartcashinvest" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Instagram</a></span>
            </div>
          </div>
        </div>
      </div>
